...
while True:
	...
	cv2.putText(frame,"Counting System:",(W-400,20),font, 0.75, (0,0,255),1)
	if count_car>0:
	...
	lineType               = 1
	cv2.putText(frame,s,bottomLeftCornerOfText,font,fontScale,fontColor,lineType)
	cx.clear()
	cy.clear()
	W_XYZ.clear()
	...
	if args["display"] > 0:
		...
		if key == ord("q"):
			...
			read_file.to_csv (r'boundary.csv', index=";")
			break
